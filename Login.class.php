...
# Description: simple multi user login script
# Author: Dhanushka Samarakoon
# Derived from: simple single user login script by ricocheting (http://www.ricocheting.com/code/php/simple-login)
# Web: http://dhanushka.net
# Update: 2012-Sep-06
# Version: 1.0
# Copyright 2012 Dhanushka.net
...
function check(){
	global $userArray;
	//Search is the username exists in the user array
	if (array_key_exists($this->user, $userArray)) {
		$LOGIN_USER = $this->user; 
		//Retrive the password for the user from the user array
		$password = $userArray[$LOGIN_USER];
		$LOGIN_PASS = $password;
	}
